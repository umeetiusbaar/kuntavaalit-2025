...
class PirkkalainenService : VaalikoneService {

    private val client = PirkkalainenClient()
    ...
    override suspend fun questionsAndAnswers(
        ...
        val questions =
            sourceQuestions.map { fi.lempimetsa.kuntavaalit2025.Question(Source.PIRKKALAINEN, it.id, it.title) }
